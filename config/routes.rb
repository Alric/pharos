Rails.application.routes.draw do
  ...
  get 'users/:id/issue_creds', to: 'users#issue_aws_credentials', format: [:json, :html], as: :issue_aws_creds_for_user
  get 'users/:id/revoke_creds', to: 'users#revoke_aws_credentials', format: [:json, :html], as: :revoke_aws_creds_for_user
